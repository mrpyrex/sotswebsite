...
SECRET_KEY = '82-_-30v5!0(382g8dh9tdmi82ax6s7%mfg&4^zq6gm^fg!$*^'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'testing/static/')]
...
EMAIL_HOST_USER = 'neupytechng@gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_PASSWORD = 'elyon2601pyrex'
